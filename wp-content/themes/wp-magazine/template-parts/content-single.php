...
<?php $post_details = get_theme_mod( 'detail_post_show_hide_details', array( 'image', 'date', 'categories', 'tags' ) ); ?>
...
<div class="single-post">
  ...
  <div class="post-content">
    ...
    <?php
      ...
      if( ! array_key_exists( 'display_featured_image', $args ) ) {
        $args['display_featured_image'] = true;
      }
    ?>
    ...
    <?php if( is_array( $post_details ) && ! empty( $post_details ) ) { ?>
      ...
      <?php if ( in_array( 'image', $post_details ) && $args['display_featured_image'] && has_post_thumbnail() ) { ?>
